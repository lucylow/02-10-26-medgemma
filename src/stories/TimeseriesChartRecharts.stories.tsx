...
import { TimeseriesChartRecharts } from "@/components/charts/TimeseriesChartRecharts";

const meta: Meta<typeof TimeseriesChartRecharts> = {
  title: "Telemetry/TimeseriesChartRecharts",
  component: TimeseriesChartRecharts,
  parameters: { layout: "padded" },
};

export default meta;
type Story = StoryObj<typeof TimeseriesChartRecharts>;
...
export const WithoutCostBar: Story = {
  args: {
    data: mockData,
    title: "Calls, errors, fallbacks",
    showCostBar: false,
  },
};
...
export const HighCost: Story = {
  args: {
    data: mockData.map((d) => ({ ...d, cost: d.cost * 10 })),
    title: "Usage & cost (elevated)",
  },
};
